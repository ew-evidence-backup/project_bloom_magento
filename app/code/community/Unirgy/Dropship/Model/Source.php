    ...
    public function toOptionHash($selector=false)
    {
        ...
        case 'vendor_po_grid_status_filter':
            $options = array(
                ...
                self::SHIPMENT_STATUS_ACK       => $hlp->__('Order Pending'), // ACKNOWLEDGED
                //self::SHIPMENT_STATUS_BACKORDER => $hlp->__('Backorder'),
                self::SHIPMENT_STATUS_ONHOLD    => $hlp->__('Delivery Attempted'),
                self::SHIPMENT_STATUS_READY     => $hlp->__('Out for Delivery'),
                //self::SHIPMENT_STATUS_PENDPICKUP => $hlp->__('Pending Pickup'),
                //self::SHIPMENT_STATUS_PARTIAL   => $hlp->__('Label(s) printed'),
                self::SHIPMENT_STATUS_SHIPPED   => $hlp->__('Delivered'),

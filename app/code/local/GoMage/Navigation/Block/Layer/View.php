 ...
 */
	...
	class GoMage_Navigation_Block_Layer_View extends Mage_Catalog_Block_Layer_View{
	    ...
	    protected function _addGlobalPosition()
        {
            $toolbar = Mage::getBlockSingleton('catalog/product_list_toolbar');
//            $this->getLayer()->getProductCollection()->addAttributeToSort('position',
//                $toolbar->getCurrentDirection());
            $this->getLayer()->getProductCollection()->addAttributeToSort('global_position',
                $toolbar->getCurrentDirection());

            //echo $this->getLayer()->getProductCollection()->getSelect()->__toString();
        }
        protected function _addPriceSort()
        {
            $toolbar = Mage::getBlockSingleton('catalog/product_list_toolbar');
            //echo $toolbar->getCurrentDirection();
             $this->getLayer()->getProductCollection()->addAttributeToSort('price',$toolbar->getCurrentDirection());
        }

...
class GoMage_Navigation_Helper_Data extends Mage_Core_Helper_Abstract{
    ...
    public function getAttributeId($code ='global_position')
    {
    ...
    public function getOptionImage($attrId, $optionId) {
	$attrId = (int)$attrId;
	$optionId = (int)$optionId;
    
        $query = "SELECT filename
			FROM gomage_navigation_attribute_option
			WHERE attribute_id=$attrId AND option_id=$optionId";

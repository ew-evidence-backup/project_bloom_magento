...
class Mage_Adminhtml_Block_Catalog_Category_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
            ...
            ->addAttributeToSelect('global_position')
        ...
        $this->_getProductZip($collection);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('image',
            array(
                ...
                'filter'    => false,
                'sortable'  => false,
                'renderer'  => 'Mage_Adminhtml_Block_Catalog_Product_Renderer_Pimage',
            ));
        ...
        $this->addColumn('zip', array(
            'header'    => Mage::helper('catalog')->__('City, State or ZIP'),
            'width'     => '120',
            'index'     => 'zip',
            'filter_index'  => 'zip'
        ));
        ...
        $this->addColumn('global_position', array(
            'header'    => Mage::helper('catalog')->__('Global Position'),
            'width'     => '1',
            'type'      => 'number',
    ...
    protected function _getProductZip($collection = null)
    {
        if($collection)
        {
            $collection->joinField('zip',
                'impl_product_zip',
                'zip',
                'product_id=entity_id',
                null,
